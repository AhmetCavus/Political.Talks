...
public class EvaluationController {
	...
	@GetMapping
    public DeferredResult<EvaluationModel> evaluationAction(@NotBlank @RequestParam String url1, @RequestParam(required = false) @Nullable String url2) throws InterruptedException, ExecutionException, IOException, CsvRequiredFieldEmptyException {
	...
	private void handleEvaluationRequest(String url1, String url2, DeferredResult<EvaluationModel> deferredResult)
			throws IOException, InterruptedException, ExecutionException, CsvRequiredFieldEmptyException {
